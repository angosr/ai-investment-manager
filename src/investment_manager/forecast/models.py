...
MAX_ACTIVE_WORLD_MECHANISMS = 6
MAX_WORLD_CAUSAL_NODES = 5
MAX_WORLD_VERIFICATION_TESTS = 3
MAX_WORLD_INVALIDATION_CONDITIONS = 3
MAX_WORLD_CONFLICTING_EVIDENCE = 8
MAX_WORLD_MECHANISM_CLAIM_CHARACTERS = 600
