...
AGGREGATED_FLOW_FACT_TYPES = frozenset(
    {
        BTC_ETF_AGGREGATE_FLOW_FACT_TYPE,
        ETH_ETF_AGGREGATE_FLOW_FACT_TYPE,
    }
)
CONTINUOUS_CONTEXT_FACT_TYPES = OFFICIAL_METRIC_FACT_TYPES | AGGREGATED_FLOW_FACT_TYPES
AGGREGATED_FLOW_RISK_FACTORS = frozenset(
    {"BTC_INSTITUTIONAL_FLOW", "ETH_INSTITUTIONAL_FLOW"}
)
