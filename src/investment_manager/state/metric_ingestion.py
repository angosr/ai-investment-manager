...
OFFICIAL_METRIC_STREAM_DOMAINS = {
    ...
    FRED_HIGH_YIELD_OAS_STREAM_ID: CausalDomain.CROSS_ASSET_EXTERNAL,
    FRED_SP500_STREAM_ID: CausalDomain.CROSS_ASSET_EXTERNAL,
    FRED_WTI_STREAM_ID: CausalDomain.CROSS_ASSET_EXTERNAL,
    ...
    STABLECOIN_SUPPLY_STREAM_ID: CausalDomain.ONCHAIN_SUPPLY,
}
