...
from quant_core.release_workflows import EVALUATE_RELEASE_ACTIVITY, ReleaseWorkflow
...
class ReleaseTemporalWorker:
    ...
    async def __aenter__(self) -> ReleaseTemporalWorker:
