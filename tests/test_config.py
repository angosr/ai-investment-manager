...
def test_shadow_config_inherits_single_baseline_without_enabling_orders() -> None:
    ...
    assert config.pipeline.version == "world-forecast-product-capital-shadow-v62"
    ...
    assert config.capital.decision.version == "portfolio-net-edge-v15"
    ...
    assert config.outcome_evaluation.version == "typed-outcome-settlement-v36"
    ...
    assert (
        ...
        == "world-model-ablation-forward-v30"
    )
